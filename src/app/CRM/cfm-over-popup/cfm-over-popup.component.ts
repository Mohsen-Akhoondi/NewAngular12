...
@Component({
  selector: 'app-cfm-over-popup',
  templateUrl: './cfm-over-popup.component.html',
  styleUrls: ['./cfm-over-popup.component.css']
})
export class CfmOverPopupComponent implements OnInit {
  ModuleCode: number;
  ModuleName;
  HeaderName;
  popupMaximized;
